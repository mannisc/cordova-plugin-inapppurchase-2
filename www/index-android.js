...
! function(t, e) { "object" == typeof exports && "undefined" != typeof module ? module.exports = e() : "function" == typeof define && define.amd ? define(e) : t.ES6Promise = e() }(this, function() {
    ...
    function x(t, n, r, o) {
        var i = e(r),
            ...
            c = void 0,
            a = void 0;
        if (i) { if (s = P(r, o), s === st ? (a = !0, u = s.error, s = null) : c = !0, n === s) return void j(n, d()) } else s = o, c = !0;
    ...
    return nativeCall('init', []).then(function() {
        ...
        if (purchases) {
            arr = purchases.map(function(val) {
                return {
                    productId: val.productId,
                    state: val.purchaseState, //UPDATED BY MANNISC
                    transactionId: val.orderId,
                    date: val.purchaseTime, //UPDATED BY MANNISC
                    type: val.type,
